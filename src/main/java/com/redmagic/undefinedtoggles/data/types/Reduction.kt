...
class Reduction(var crystals: Double, var tntMinecart: Double, var tnt: Double, var anchors: Double, var bedExplosions: Double, var fallDamage: Double, private val plugin: UndefinedToggles) {
